...
class Plot:
    ...
    def NNPlot_epochs(
        ...
        plt.plot(x_plt, y_plt3.cpu(), KColor[2], label=Klegend[2])

        # KF
        y_plt4 = MSE_KF_dB_avg * torch.ones(N_Epochs_plt)
        plt.plot(x_plt, y_plt4.cpu(), KColor[3], label=Klegend[3])
    ...
    def NNPlot_Hist(self, MSE_KF_data_linear_arr, MSE_KN_linear_arr):
        ...
        plt.figure(figsize=(25, 10))
        sns.distplot(
            10 * torch.log10(MSE_KN_linear_arr).cpu(),
            hist=False,
            kde=True,
            kde_kws={"linewidth": 3},
            color="g",
        ...
        sns.distplot(
            10 * torch.log10(MSE_KF_data_linear_arr).cpu(),
            hist=False,
            kde=True,
            kde_kws={"linewidth": 3},
            color="r",
